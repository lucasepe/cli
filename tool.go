...
func New(binaryName, description string) *Tool {
	c := &Tool{
...
func (c *Tool) RegisterCommand(cmd *Command) error {
...
func (c *Tool) printDefaultHelp(w io.Writer) {
...
// collectCommands
func (c *Tool) collectCommandsForHelp() []*printableCommand {
